                            ...
                            int flags)
{
  ...
  e = av_dict_get(opts, "devname", NULL, 0);
  if (e)
  {
    ni_logan_ctx->device_name = e->value;
  }
...
static int ni_logan_frames_init(AVHWFramesContext *ctx)
{
  ...
  ni_logan_ctx->api_ctx.hw_name = device_hwctx->device_name;
  ...
  ret = ni_logan_device_session_init_framepool(&ni_logan_ctx->api_ctx, pool_size, 0);
  if (ret < 0)
  {
    return ret;
  }
