...
AVCodec
#endif
ff_h264_ni_logan_decoder = {
#if (LIBAVCODEC_VERSION_MAJOR > 59 || (LIBAVCODEC_VERSION_MAJOR >= 59 && LIBAVCODEC_VERSION_MINOR >= 37))
  .p.name           = "h264_ni_logan_dec",
  .p.long_name      = NULL_IF_CONFIG_SMALL("H.264 NetInt Logan decoder v" NI_LOGAN_XCODER_REVISION),
  ...
  .caps_internal  = FF_CODEC_CAP_SETS_PKT_DTS, // not compatible with FF_CODEC_RECEIVE_FRAME_CB
